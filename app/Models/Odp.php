...
class Odp extends Model
{
    ...
    public function scopeNearCapacity(Builder $query, int $threshold = 80): Builder
    {
        return $query->whereRaw('(used_ports / total_ports * 100) >= ?', [$threshold]);
    }
}
